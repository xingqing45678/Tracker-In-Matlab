...
fs={'channels/convConst.cpp', 'channels/gradientMex.cpp',...
  ...
  'videos/opticalFlowHsMex.cpp'   };%'matlab/fibheap.cpp' ,
...
try %#ok<ALIGN>
  d=[rd '/matlab/private/']; 
  fprintf(' -> %s\n',[d 'dijkstra1.cpp']);
  mex([d 'fibheap.cpp'],  [d 'dijkstra1.cpp'],'-largeArrayDims', opts{:}, [d 'dijkstra1.' mexext]);
%   mex([d 'fibheap.cpp'],  opts{:}, [d 'fibheap.' mexext]);
%   fprintf(' -> %s\n',[d 'dijkstra1.cpp']);
%   mex([d 'dijkstra1.cpp'], opts{:}, [d 'dijkstra1.' mexext]);
catch err, fprintf(errmsg,[f1 e],err.message); end
